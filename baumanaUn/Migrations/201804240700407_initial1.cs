namespace baumanaUn.Migrations
{
    ...
    public partial class initial1 : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Level = c.String(),
                        HumanType = c.String(),
                        CoursePrice = c.Single(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Location = c.String(),
                        DateTimeStartCourse = c.DateTime(nullable: false),
                        CourseId = c.Int(nullable: false),
                        SeatInStock = c.Int(nullable: false),
                        SeatAvailable = c.Int(nullable: false),
                        SeatReserve = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Orders", "GradeId", "dbo.Grades");
            ...
            DropIndex("dbo.Orders", new[] { "GradeId" });
